...
#    output, flagFile = outFiles
#     #------------------------------build shell command-------------------------------------
#    headParams = 'tophat -p 8 -G ' + refTranscriptome + ' '
#    mapParams = '--read-mismatches 4 --read-gap-length 3 --read-edit-dist 3 --library-type fr-firststrand '
#    midParams = '-o ' + output+'_out ' + '--mate-inner-dist 1 '
#    comm = headParams + midParams + mapParams + refGenome + ' ' + read1 + ' ' + read2
#    #---------------------------------------------------------------------------------------  
#    started = time.strftime('%X %x %Z')
#    print 'running task trimmomatic at {0}'.format(started)
#    print comm
